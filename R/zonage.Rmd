...
dt[types == "Entete_appelant Entete_avocat", types := "Entete_appelant_avec_avocat"]
dt[types == "Entete_avocat Entete_intime", types := "Entete_intime_avec_avocat"]

dt_cleaned <- dt[types != "n_a"]
```
