...
local({
  dt_cleaned[, features_with_type_label := paste(add_prefix("__label__", types_clean), features_without_label)]
...
local({
  dt_cleaned[, features_with_type_macro := paste(add_prefix("__label__", types_macro), features_without_label)]
  temp_file_train <- tempfile()
  temp_file_model <- tempfile()
...
local({
  dt_cleaned[, features_with_side_label := paste(add_prefix("__label__", side), features_without_label)]
  temp_file_train <- tempfile()
  temp_file_model <- tempfile()
