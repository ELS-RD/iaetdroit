...
L'introduction de chaque décision (dans notre cas les 20 premiers %) renseigne en général sur la nature des parties, elle est extraite de chaque décision. L'ajout de la position ne semble pas beaucoup aider lorsque l'introduction est en contexte mais est importante lorsqu'elle est absente (+1/+2 points selon les taches).
